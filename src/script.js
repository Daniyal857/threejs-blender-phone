...
gltfLoader.load('iphone.gltf', gltf => {
  ...
  tl.to(gltf.scene.rotation, { y: 4.3, duration: 1 });
  tl.to(gltf.scene.scale, { x: 0.25, y: 0.25, z: 0.25, duration: 1 }, '-=1');
  tl.to(heading, { translateY: 0, autoAlpha: 1 }, '-=1');
  tl.to(desc, { translateY: 0, autoAlpha: 1 }, '-=0.7');
});
